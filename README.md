...
* [Global scope using the default serial spec runner](../../tree/global_serial)
...
* [Per spec scope using specification scoped variables](../../tree/per_spec_serial_specification_scoped)
